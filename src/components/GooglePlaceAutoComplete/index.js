...
import { TextInput, View, ListView, ScrollView, Image, Text, StyleSheet, Dimensions, TouchableHighlight, TouchableWithoutFeedback,
    TouchableOpacity, Platform, ActivityIndicator, PixelRatio } from 'react-native';
import Qs from 'qs';
...
const GooglePlacesAutocomplete = React.createClass({
    ...
    _renderRowData(rowData) {
        ...
        return (
            <Text style={[
                {flex: 1, marginHorizontal: 5, color: Colors.textPrimary},
    ...
    _renderRow(rowData = {}, sectionID, rowID) {
        return (
            <View
                ...
                >
                    <View style={[defaultStyles.row, rowData.isPredefinedPlace ? this.props.styles.specialItemRow : {}]}>
        ...
        return (
            <View style={[defaultStyles.container, this.props.styles.container]}>
                <View style={[defaultStyles.textInputContainer, this.props.styles.textInputContainer]}>
                    ...
                    <View style={[defaultStyles.textInputHome]}>
                        <TextInput
                            { ...userProps }
                            ref="textInput"
                            ...
                            style={[defaultStyles.textInputView, this.props.styles.textInput]}
                            value={this.state.address ? this.state.address : this.state.text}
                ...
                {(this.state.text !== '' || this.props.predefinedPlaces.length || this.props.currentLocation === true) && this.state.listViewDisplayed === true ? this._getCurrentLocationView() : null}
                {this._getListView()}
                {this.props.children}
            </View>
        );
