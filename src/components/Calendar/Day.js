...
export default class Day extends Component {
    ...
    dayCircleStyle = (isWeekend, isSelected, isToday, event, eventA) => {
        ...
        if (eventA) {
            if (isSelected) {
                dayCircleStyle.push(styles.hasEventDaySelectedCircle, customStyle.hasEventDaySelectedCircle, eventA.hasEventADaySelectedCircle);
            } else {
                dayCircleStyle.push(styles.hasEventACircle, customStyle.hasEventACircle, eventA.hasEventACircle);
            }
        }
        return dayCircleStyle;
    };

    dayTextStyle = (isWeekend, isSelected, isToday, event, eventA) => {
        const { customStyle } = this.props;
        ...
        if (eventA) {
            dayTextStyle.push(styles.hasEventText, customStyle.hasEventText, eventA.hasEventAText)
        }
        return dayTextStyle;
    };
            ...
            : (
                <TouchableOpacity onPress={this.props.onPress}>
                    <View style={[styles.dayButton, customStyle.dayButton]}>
                        <View style={this.dayCircleStyle(isWeekend, isSelected, isToday, event, eventA)}>
                            <Text style={this.dayTextStyle(isWeekend, isSelected, isToday, event, eventA)}>{caption + ''}</Text>
                        </View>
                        {showEventIndicators &&
                        <View style={[
